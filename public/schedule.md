...
- 平日の科目配分（月〜水B、木〜金C）は目安。ノっているならそのまま続けてよい
- 週末に終日予定が入る場合は、平日に講義を前倒し or 後ろ倒しで補う
- A科目はWeek8（現代パート）以降、1トピックに2週間かける「じっくり深掘りモード」。B/Cは1トピック1週ペースを維持する
- A科目はWeek12（統合エッセイ初稿）が2Qへの「蝶番」。B/Cは6月末〜7月頭に1Qの弧を閉じる
- CがW10-11で渡す技術基盤（RAG・エージェント・MCP）が、AのW10-11（AI革命・MCP）より先に着地するよう保つ
...
### Week 9: スマートフォン — 「常時接続」の社会（2026-06-07 〜 2026-06-20）
...
- 2026-06-20: A科目パターン抽出③（Week 7-9）
- 2026-06-27: B科目 1Q統合レポート完了
- 2026-07-04: C科目 1Q統合レポート完了
- 2026-07-18: A科目 AI革命パターン整理（Week 10-11）
- 2026-08-01: A科目 統合エッセイ初稿 ＝ 2Qへの蝶番
