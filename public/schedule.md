...
- CのMCP（C Week 11＝7/4）はAのMCP分析（A Week 11＝7/5〜）より先に着地させる（依存はタイト）
...
- [ ] A接続: この技術理解を A Week 11 のMCP歴史分析の前提として渡す（7/5より先に着地）

### Week 12: 統合 — プロンプトの旅（2026-07-05 〜 2026-07-11）
- [ ] プロンプト入力→トークン化→Embedding→Transformer→生成の全体を図解
- [ ] 統合レポート執筆（図+文章:「Claudeに質問してから回答が返るまで」）
- [ ] この一本を描く過程で深掘りアークの的を確定する
- [ ] B科目レポートとの統合を検討

### Week 13: 深掘り・内 — Embedding-Transformer（2026-07-12 〜 2026-07-18）
...
### Week 14: 深掘り・外 — MCP（2026-07-19 〜 2026-07-25）
...
- 2026-07-18: B科目 定着アーク完了＝1Qの弧を閉じる
- 2026-07-19: A科目 統合エッセイ着手
- 2026-07-25: C科目 深掘りアーク完了＝1Qの弧を閉じる
